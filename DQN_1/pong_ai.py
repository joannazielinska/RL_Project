...
from DQN_1.agent import Agent, Policy, Memory
import argparse
...
decay = 0.001 #expotential decay rate for exploration prob
memory_size = 10000
batch_size = 64
update_step = 1000
...
'''
Preprocessing the frame to reduce the load on system :
