...
def train(episodes, player, opponent):
    ...
    for i in range(0,episodes):
        ...
        #epsilon = explore_end + (explore_start - explore_end) * \
        #math.exp(-1. * i / explore_decay)
        ...
        while not done:
            ...
            #    epsilon = explore_end + (explore_start - explore_end) * \
            #    math.exp(-1. * timesteps / explore_decay)
